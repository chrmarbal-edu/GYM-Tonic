...
VALUES
    ('Press Banca con Mancuernas', 'Acostado en un banco plano, empuja las mancuernas hacia arriba desde el nivel del pecho hasta extender los brazos. Controla el descenso para trabajar el pectoral mayor y tríceps.', 1, 'press_banca_con_mancuernas.mp4', 'press_banca_con_mancuernas.png'),
    ('Fondos en Paralelas', 'Sujétate del respaldo de dos sillas estables y desciende el cuerpo flexionando los codos. Empuja hacia arriba para volver a la posición inicial, enfocando el esfuerzo en los tríceps.', 4, 'fondos_en_paralelas.mp4', 'fondos_en_paralelas.png'),
    ('Crunch Abdominal en Máquina', 'Sentado en la máquina, flexiona el torso hacia adelante contrayendo los abdominales contra la resistencia. Mantén el movimiento controlado para maximizar la activación del core.', 9, 'crunch_abdominal_en_maquina.mp4', 'crunch_abdominal_en_maquina.png'),
    ('Remo con Barra', 'Con el torso inclinado y la espalda recta, tira de la barra hacia la parte baja del abdomen. Junta las escápulas al final del movimiento para trabajar la densidad de la espalda.', 2, 'remo_con_barra.mp4', 'remo_con_barra.png'),
    ('Curl de Muñeca con Mancuernas', 'Apoya los antebrazos sobre un banco plano y realiza flexiones de muñeca con las mancuernas. Este ejercicio aísla y fortalece los flexores del antebrazo', 3, 'curl_de_muneca_con_mancuernas.mp4', 'curl_de_muneca_con_mancuernas.png'),
    ('Cruce de Poleas', 'De pie entre dos poleas, lleva los agarres hacia el centro del cuerpo cruzándolos ligeramente. Mantén una flexión mínima en los codos para trabajar el pectoral de forma aislada.', 1, 'cruce_de_poleas.mp4', 'cruce_de_poleas.png'),
    ('Zancada con Mancuerna Overhead', 'Realiza una zancada manteniendo una mancuerna extendida sobre la cabeza. Este movimiento trabaja intensamente los cuádriceps, glúteos y la estabilidad del hombro.', 5, 'zancada_con_mancuerna_overhead.mp4', 'zancada_con_mancuerna_overhead.png'),
    ('Sentadilla Frontal con Barra', 'Coloca la barra sobre la parte anterior de los hombros y desciende manteniendo el torso erguido. Esta variante enfoca el trabajo en los cuádriceps y reduce la carga en la espalda baja.', 5, 'sentadilla_frontal_con_barra.mp4', 'sentadilla_frontal_con_barra.png'),
    ('Clean and Press con Barra', 'Levanta la barra desde el suelo hasta los hombros en un movimiento explosivo y luego empújala sobre la cabeza. Trabaja potencia, piernas, espalda y hombros.', 10, 'clean_and_press_con_barra.mp4', 'clean_and_press_con_barra.png'),
    ('Remo al Mentón con Barra', 'Sujeta la barra con un agarre estrecho y elévala verticalmente hacia el mentón manteniendo los codos por encima de las manos. Enfocado en deltoides y trapecios.', 7, 'remo_al_menton_con_barra.mp4', 'remo_al_menton_con_barra.png'),
    ('Flexiones de Brazos', 'Manteniendo el cuerpo recto, desciende el pecho hacia el suelo mediante la flexión de los brazos y vuelve a subir. Ejercicio fundamental de empuje para pectoral y tríceps.', 1, 'flexiones_de_brazos.mp4', 'flexiones_de_brazos.png'),
    ('Hiperextensiones Lumbares', 'En un banco específico, desciende el torso y elévalo hasta quedar alineado con las piernas. Fortalece la musculatura lumbar, glúteos e isquiotibiales.', 2, 'hiperextensiones_lumbares.mp4', 'hiperextensiones_lumbares.png'),
    ('Press Militar con Mancuernas Sentado', 'Sentado en un banco con respaldo, empuja las mancuernas verticalmente desde los hombros hasta extender los brazos por completo. Enfoca el esfuerzo en los deltoides y mantén el core estable.', 7, 'press_militar_con_mancuernas_sentado.mp4', 'press_militar_con_mancuernas_sentado.png'),
    ('Press Francés con Barra', 'Acostado en un banco, baja la barra hacia la frente flexionando los codos y luego extiéndelos para trabajar de forma aislada el tríceps braquial.', 4, 'press_frances_con_barra.mp4', 'press_frances_con_barra.png'),
    ('Hip Thrust con Mancuerna', 'Apoyando la parte superior de la espalda en un banco, eleva la cadera con peso sobre la pelvis hasta alinear el cuerpo, contrayendo intensamente glúteos y cuádriceps.', 5, 'hip_thrust_con_mancuerna.mp4', 'hip_thrust_con_mancuerna.png'),
    ('Extensión de Tríceps sobre la Cabeza con Polea', 'De espaldas a la máquina y con un pie adelantado, extiende los brazos hacia adelante y arriba usando la polea para trabajar la cabeza larga del tríceps.', 4, 'extension_de_triceps_sobre_la_cabeza_con_polea.mp4', 'extension_de_triceps_sobre_la_cabeza_con_polea.png'),
    ('Sentadilla Búlgara con Mancuernas', 'Con un pie apoyado atrás en un banco, desciende la cadera manteniendo la espalda recta. Este ejercicio enfoca el trabajo intensamente en el cuádriceps de la pierna delantera y el glúteo.', 5, 'sentadilla_bulgara_con_mancuernas.mp4', 'sentadilla_bulgara_con_mancuernas.png'),
    ('Peso Muerto con Mancuerna', 'Manteniendo las piernas ligeramente flexionadas, baja las mancuernas hacia el suelo con la espalda recta y sube mediante la extensión de cadera. Trabaja cuádriceps y zona lumbar.', 5, 'peso_muerto_con_mancuerna.mp4', 'peso_muerto_con_mancuerna.png'),
    ('Press de Hombros con Mancuernas Sentado', 'Sentado sin apoyo lumbar, empuja las mancuernas hacia arriba desde la altura de las orejas. Requiere mayor estabilidad del core para trabajar deltoides y tríceps.', 7, 'press_de_hombros_con_mancuernas_sentado.mp4', 'press_de_hombros_con_mancuernas_sentado.png'),
    ('Press Arnold con Mancuernas', 'Empieza con las palmas hacia ti a la altura de los hombros, gira las muñecas mientras empujas hacia arriba hasta que las palmas miren al frente. Excelente para el deltoide completo.', 7, 'press_arnold_con_mancuernas.mp4', 'press_arnold_con_mancuernas.png'),
    ('Dominadas Asistidas', 'Utiliza la máquina de asistencia para realizar una tracción vertical. Se enfoca principalmente en el desarrollo del dorsal ancho y la musculatura de la espalda alta.', 2, 'dominadas_asistidas.mp4', 'dominadas_asistidas.png'),
    ('Sentadilla Goblet', 'Sujeta una mancuerna frente al pecho y desciende flexionando rodillas y cadera. Excelente para trabajar cuádriceps y glúteos manteniendo el torso erguido.', 5, 'sentadilla_goblet.mp4', 'sentadilla_goblet.png'),
    ('Press Francés con Mancuernas', 'Acostado en un banco, flexiona los codos para bajar las mancuernas hacia las sienes y luego extiende totalmente. Aísla y fortalece las cabezas del tríceps.', 4, 'press_frances_con_mancuernas.mp4', 'press_frances_con_mancuernas.png');
    -- ('Cruces en Polea Alta', 'De pie entre poleas altas, tira de los agarres hacia el centro y abajo del cuerpo. Ideal para trabajar la contracción máxima de las fibras de los pectorales.', 1, 'cruces_en_polea_alta.mp4', 'cruces_en_polea_alta.png');
GO
