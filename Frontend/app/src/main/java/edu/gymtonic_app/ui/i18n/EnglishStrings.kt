...
val EnglishStrings = AppStrings(
    ...
    register = RegisterStrings(
        ...
        passwordTooWeak = "Password must be at least 8 characters long and include an uppercase letter, a lowercase letter, a number, and a symbol",
        nextButton = "NEXT",
    ...
    training = TrainingStrings(
        ...
        trainingAll = "All",
        invalidSeriesRange = "Must be between 1 and 10",
        invalidRepsRange = "Must be between 1 and 100"
    ),
    profile = ProfileStrings(
        ...
        noMyRoutines = "You haven't created any routines yet",
        myGroups = "My groups",
